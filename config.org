...
#+BEGIN_SRC emacs-lisp 
  ...
  (setq org-publish-project-alist
        '(
          ("posts"
           :base-directory "~/personal_projects/website-clj/resources/org-posts"
           :base-extension "org"
           :publishing-directory "~/personal_projects/website-clj/resources/posts"
           :publishing-function org-html-publish-to-html
           :headline-levels 4
           :html-extension "html"
           :body-only t) 
          ("clj-site" :components ("posts"))))
#+END_SRC

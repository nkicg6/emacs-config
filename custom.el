(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (org ox emacs-htmlize ox-publish pipenv paredit paredit-mode leuven-theme material-theme projectile s rainbow-delimiters use-package org-link-minor-mode)))
